...
/**
 * Snapshot of weapon input per frame. For melee combat, the attack button and world cursor
 * coordinates are sufficient. In network mode, the cursor can be replaced with the gaze direction.
 */
