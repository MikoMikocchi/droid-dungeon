...
/**
 * Casts 2D shadows from light sources based on wall/block geometry. Uses ray casting to determine
 * shadow edges and creates shadow geometry.
 */
public class ShadowCaster {
  ...
  /**
   * Cast shadows from a light source and return the lit area polygon. The result is a polygon that
   * represents the area visible from the light.
   *
  ...
  private float findTileEdgeIntersection(
      float startX,
      float startY,
      float dirX,
      float dirY,
