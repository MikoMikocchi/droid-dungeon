 ...
 * Supports warm torch-like colors, smooth falloff, and flickering effects.
 */
public class Light {
    /** World position X */
    protected float x;
    ...
    public void setRadius(float radius) { this.radius = Math.max(1f, radius); }
    public Color getColor() { return color; }
    public void setColor(Color color) { this.color.set(color); }
    public void setColor(float r, float g, float b) { this.color.set(r, g, b, 1f); }
    ...
    public void setInnerRadiusRatio(float ratio) { this.innerRadiusRatio = Math.max(0f, Math.min(0.5f, ratio)); }
    public boolean isFlickerEnabled() { return flickerEnabled; }
    public void setFlickerEnabled(boolean enabled) { this.flickerEnabled = enabled; }
    public float getFlickerSpeed() { return flickerSpeed; }
    public void setFlickerSpeed(float speed) { this.flickerSpeed = speed; }
    public float getFlickerIntensityRange() { return flickerIntensityRange; }
    public void setFlickerIntensityRange(float range) { this.flickerIntensityRange = range; }
    public float getFlickerRadiusRange() { return flickerRadiusRange; }
    public void setFlickerRadiusRange(float range) { this.flickerRadiusRange = range; }
    public boolean isActive() { return active; }
    public void setActive(boolean active) { this.active = active; }
    public float getFalloffExponent() { return falloffExponent; }
    public void setFalloffExponent(float exponent) { this.falloffExponent = Math.max(0.5f, exponent); }
