...
public final class MiningSystem {
  ...
  public void update(
    ...
    // If a weapon (or any item without a mining tool type) is equipped, disable mining and
    // highlighting.
    ...
    boolean targetChanged =
        this.targetX != targetX || this.targetY != targetY || this.targetBlock != block;
    if (targetChanged) {
    ...
    progressRatio =
        MathUtils.clamp(remainingHealth <= 0f ? 1f : accumulatedDamage / remainingHealth, 0f, 1f);
