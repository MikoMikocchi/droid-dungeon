...
public final class DebugTextBuilder {
  ...
  public String build(
    ...
    text.append("\n\n");
    text.append("Network: pendingInputs=")
        .append(pendingInputsCount)
        .append("  |  lastAck=")
        .append(lastProcessedTick)
        .append("\n");
  ...
  private void appendEquippedInfo(
      InventorySystem inventorySystem, ItemRegistry itemRegistry, StringBuilder text) {
  ...
  private void appendPlayerAndEnemyInfo(
      PlayerStats playerStats, EnemySystem enemySystem, StringBuilder text) {
    text.append("\nHP: ")
        .append(Math.round(playerStats.getHealth()))
        .append("/")
        .append((int) playerStats.getMaxHealth());
    if (enemySystem != null) {
