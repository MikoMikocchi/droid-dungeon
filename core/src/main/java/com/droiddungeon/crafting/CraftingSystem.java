...
public final class CraftingSystem {
    ...
    public CraftingSystem(Inventory inventory, ItemRegistry itemRegistry, List<CraftingRecipe> recipes) {
    ...
    public boolean canCraft(int recipeIndex) {
        ...
        CraftingRecipe recipe = recipes.get(recipeIndex);
        return hasAllIngredients(recipe) && wouldFitAfterConsume(recipe, recipe.createResultStack(itemRegistry));
    }
